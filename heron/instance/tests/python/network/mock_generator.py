...
from heronpy.common.src.python.basics import EventLooper
from heronpy.common.src.python.network import SocketOptions
from heronpy.common.src.python.utils.misc import HeronCommunicator
from heron.instance.src.python.network import SingleThreadStmgrClient, MetricsManagerClient
import heronpy.common.src.python.system_constants as constants
...
class MockSTStmgrClient(SingleThreadStmgrClient):
  ...
  def __init__(self):
    ...
    with patch("heronpy.common.src.python.config.system_config.get_sys_config",
