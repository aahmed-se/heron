...
from heronpy.common.utils.metrics import MetricsCollector
from heronpy.common.utils.misc import (OutgoingTupleHelper, PhysicalPlanHelper,
                                                HeronCommunicator)
from heron.proto import tuple_pb2

import heronpy.common.system_constants as constants
import heronpy.common.tests.mock_protobuf as mock_protobuf
...
class MockOutgoingTupleHelper(OutgoingTupleHelper):
  ...
  def __init__(self, mode=SAMPLE_SUCCESS):
    ...
    if mode == MockOutgoingTupleHelper.SAMPLE_SUCCESS:
      ...
      with patch("heronpy.common.config.system_config.get_sys_config",
