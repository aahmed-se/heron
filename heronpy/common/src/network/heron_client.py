...
import time
from heronpy.common.network import HeronProtocol, REQID, StatusCode, OutgoingPacket
...
class HeronClient(asyncore.dispatcher):
  ...
  def __init__(self, looper, hostname, port, socket_map, socket_options):
    ...
    :type looper: ``GatewayLooper`` (heronpy.common.basics)
    ...
    :type socket_options: ``SocketOptions`` (heronpy.common.network)
